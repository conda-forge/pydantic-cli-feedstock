...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pydantic-cli-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14557&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pydantic-cli-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pydantic-cli` can be installed with:

```
conda install pydantic-cli
```

It is possible to list all of the versions of `pydantic-cli` available on your platform with:
